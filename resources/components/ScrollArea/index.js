...
import {findDOMNode, modifyObjValues, positiveOrZero, warnAboutElementChild, warnAboutFunctionChild,} from './utils';
...
ScrollArea.defaultProps = {
	...
	focusableTabIndex        : 1,
	verticalScrollbarStyle   : {width : '5px', borderRadius : '3px'},
	horizontalScrollbarStyle : {width : '5px', borderRadius : '3px'},
	verticalContainerStyle   : {width : '7px'},
	horizontalContainerStyle : {width : '7px'},
};
