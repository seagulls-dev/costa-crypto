...
import BitcoinCashIcon from 'react-cryptocoins/dist/icons/BTC';
...
class BitcoinCashPrice extends Component {
	constructor(props) {
		super(props);
		...
		return (
			<Spin spinning={loading}>
				<ChartCard value={formattedPrice}
				           ...
				           styleName="mb-0"
				           icon={<BitcoinCashIcon style={{color: '#41750a'}}/>}
				           children={
					           <ResponsiveContainer width="100%" height={32}>
						           <AreaChart data={chartData}
							           ...
							           <defs>
								           <linearGradient id="bitcoinCashColor" x1="0" y1="0" x2="1" y2="0">
									           <stop offset="5%" stopColor="#8dc351" stopOpacity={0.9}/>
									           <stop offset="95%" stopColor="#41750a" stopOpacity={0.9}/>
								           </linearGradient>
							           </defs>
...
export default BitcoinCashPrice;