...
import BitcoinIcon from 'react-cryptocoins/dist/icons/BTC';
		...
		return (
			<Spin spinning={loading}>
				<ChartCard value={formattedPrice}
				           title="Bitcoin Price"
				           styleName="mb-0"
				           icon={<BitcoinIcon style={{color: '#bb8414'}}/>}
				           children={
					           <ResponsiveContainer width="100%" height={32}>
						           <AreaChart data={chartData}
							           ...
							           <defs>
								           <linearGradient id="bitcoinColor" x1="0" y1="0" x2="1" y2="0">
									           <stop offset="5%" stopColor="#e4cf3a" stopOpacity={0.9}/>
									           <stop offset="95%" stopColor="#bb8414" stopOpacity={0.9}/>
								           </linearGradient>
							           </defs>
