...
import WidgetGridLayout from "admin/components/WidgetGridLayout";
...
class Home extends Component {
	...
	fetchData() {
		...
		const endpoint = route('admin.home.widget.list');
	...
	saveLayout = () => {
		...
		const endpoint = route('admin.home.widget.set-dimensions');
