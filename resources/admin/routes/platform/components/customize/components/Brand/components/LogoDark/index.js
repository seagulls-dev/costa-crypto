...
class LogoDark extends Component {
	...
	render() {
		...
		const endpoint = route('admin.platform.customize.brand.upload-logo-dark').url();
								...
								{!context.logoDarkUrl ? (
									<React.Fragment>
										...
										<div className="rounded p-2">
											<img alt={context.name} src={require("assets/images/logo-dark.png")}/>
										</div>
									</React.Fragment>
								): (
									<React.Fragment>
										...
										<div className="rounded p-2">
											<img alt={context.name} src={context.logoDarkUrl}/>
										</div>
									</React.Fragment>
								)}
							</Col>
