...
class BitcoinGoldAdapter extends CoinAdapter
{
	...
	private function init()
	{
		...
		if (config()->get('bitgo.env') == "prod") {
			$bitgo->setCoin(Coin::BITCOIN_GOLD);
		} else {
			throw new AdapterException("Bitcoin Gold is only available in BitGO production environment.");
		}
