...
namespace HolluwaTosin360\Currency;
...
class Currency
{
	...
	public function convert($amount, $from = null, $to = null, $format = true)
	{
		...
		// Get exchange rates
		$fromRate = $this->getCurrencyProp($from, 'exchange_rate');
		$toRate = $this->getCurrencyProp($to, 'exchange_rate');
	 ...
	 * Get storage driver.
	 *
	 * @return \HolluwaTosin360\Currency\Contracts\DriverInterface
	 */
	 ...
	 *
	 * @return \HolluwaTosin360\Currency\Contracts\FormatterInterface
	 */
